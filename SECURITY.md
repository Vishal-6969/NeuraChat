NeuraInbox is looking forward to working with security researchers worldwide to keep NeuraInbox and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against NeuraInbox production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping NeuraInbox and our users safe. 🙇
